...
include { CREATE_SRA_SAMPLESHEET         } from '../modules/local/samplesheets/createsra/main'
...
include { ENTREZDIRECT_ESEARCH           } from '../modules/local/entrezdirect/esearch/main'
include { RENAME_SRA_FASTA               } from '../modules/local/assets/rename/sra/main'
include { CONFIRM_DUPS                   } from '../subworkflows/local/confirm_dups/main'
...
workflow SRA_PREP {
    ...
    main:
        ...
        outdir_path = Channel.fromPath(params.outdir)
