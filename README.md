...
For full documentation on the pipeline see the [Wiki](https://github.com/cdcgov/phoenix/wiki), but quick start instructions are provided below if you are feeling brave.
...
6. Start running your own analysis with a [samplesheet](https://github.com/cdcgov/phoenix/wiki/Running-PHoeNIx#samplesheet-input)!
