...
if grep "FAILED: Read pairs are NOT the same!" ${prefix}_result.txt; then
	...
	#file contents
	echo "${prefix}	FAIL	Unknown	Unknown	Unknown	Unknown	Unknown	Unknown	Unknown	Unknown	Unknown	Unknown	Unknown	kraken2_trimmed	Unknown	Unknown	Unknown	Unknown	Unknown	Unknown	Unknown	Unknown	Unknown	Unknown	Unknown		FAILED: Read pairs are NOT the same!" | tr -d '\n' >> ${prefix}_summaryline_failure.tsv
fi 
