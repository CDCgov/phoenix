...
task phoenix {
  ...
  output {
    ...
    #phoenix gamma
    File gamma_ar_calls           = "~{samplename}/results/~{samplename}/gamma_ar/~{samplename}_ResGANNCBI_20210507_srst2.gamma"
    File blat_ar_calls            = "~{samplename}/results/~{samplename}/gamma_ar/~{samplename}_ResGANNCBI_20210507_srst2.psl"
    ...
    File gamma_pf_calls           = "~{samplename}/results/~{samplename}/gamma_pf/~{samplename}_PF-Replicons_20220414.gamma"
    File blat_pf_calls            = "~{samplename}/results/~{samplename}/gamma_pf/~{samplename}_PF-Replicons_20220414.psl"
    #phoenix output
    File assembly_ratio_file      = "~{samplename}/results/~{samplename}/~{samplename}_Assembly_ratio_20210819.txt"
    File gc_content_file          = "~{samplename}/results/~{samplename}/~{samplename}_GC_content_20210819.txt"
