...
task phoenix {
  ...
  output {
    ...
    String  genome_length                     = read_int("GENOME_LENGTH") #make string for cases where it's "unknown"
    String  assembly_ratio                    = read_string("ASSEMBLY_RATIO")
    String  scaffold_count                    = read_int("NUM_SCAFFOLDS") #make string for cases where it's "unknown"
    String  gc_percent                        = read_float("GC_PERCENT") #make string for cases where it's "unknown"
    ...
    String  taxa_coverage                     = read_float("TAXA_COVERAGE") #make string for cases where it's "unknown"
