...
def back_2_MLST(to_convert):
    pubmlst_to_mlst = { 'Acinetobacter_baumannii#1' : 'abaumannii(Oxford)',
            'Acinetobacter_baumannii#2' : 'abaumannii(Pasteur)',
            'Achromobacter_spp.' : 'achromobacter',
            'Aeromonas_spp.' : 'aeromonas',
            'Anaplasma_phagocytophilum' : 'aphagocytophilum',
            'Arcobacter_spp.' : 'arcobacter',
            'Bartonella_bacilliformis' : 'bbacilliformis',
            'Burkholderia_cepacia_complex' : 'bcc',
            'Bacillus_cereus' : 'bcereus',
            'Brachyspira_hampsonii' : 'bhampsonii',
            ...
            'Yersinia_pseudotuberculosis' : 'ypseudotuberculosis',
