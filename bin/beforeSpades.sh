...
echo "${sample_name}\tFAIL\tUnknown\tUnknown\tUnknown\tUnknown\tUnknown\tUnknown\tUnknown\tUnknown\tUnknown\tUnknown\tUnknown\tUnknown\tUnknown\t${name}\tUnknown\tUnknown\tSPAdes_Failure" | tr -d '\n' > ${sample_name}_summaryline_failure.tsv
