...
def List_TSV(output_file, input_list):
    ...
    Out.write('ID\tQC_Outcome\tCoverage\tGenome_Length\tAssembly_Ratio_(STDev)\t#_of_Scaffolds_>500bp\tSpecies\tTaxa_Confidence\tTaxa_Source\tMLST_Scheme\tMLST\tGC_%\tKraken2_Trimd\tKraken2_Weighted\tBeta_Lactam_Resistance_Genes\tOther_AR_Genes\tHypervirulence_Genes\tAMRFinder_Point_Mutations\tQC_Reason\n')
