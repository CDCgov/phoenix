...
def List_TSV(output_file, input_list):
    ...
    Out.write('ID\tCoverage\tGenome_Length\tAssembly_Ratio_(STDev)\t#_of_Contigs\tSpecies\tPercent_ANI_Match\tTaxa_Source\tMLST_Scheme\tMLST\tGC_%\tBeta_Lactam_Resistance_Genes\tOther_AR_Genes\tHypervirulence_Genes\tQC_Outcome\tQC_Reason\n')
