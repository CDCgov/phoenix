...
def List_TSV(output_file, input_list):
    ...
    Out.write('ID\tCoverage\tGenome_Length\tAssembly_Ratio_(STDev)\t#_of_Contigs_>500bp\tSpecies\tTaxa_Confidence\tTaxa_Source\tMLST_Scheme\tMLST\tGC_%\tBeta_Lactam_Resistance_Genes\tOther_AR_Genes\tHypervirulence_Genes\tKraken2_Trimd\tKraken2_Weighted\tQC_Outcome\tQC_Reason\n')
