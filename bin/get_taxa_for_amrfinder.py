...
def parseArgs(args=None):
    ...
    parser.add_argument(
        ...
        dest="taxa_file",
        required=True,
        help=".tax file that comes from determine_taxID.sh",
    )
    parser.add_argument(
        "-o", "--output", dest="output", required=True, help="name of output file"
    )
    parser.add_argument(
...
def complicated_genus(gen_sp, genus_match):
    ...
    Burkholderia_cepacia = [
        ...
        "unclassified_Burkholderia_cepacia_complex",
    ]
    # Burkholderia pesudomallei complex
    Burkholderia_pseudomallei = [
        "Burkholderia_humptydooensis",
        "Burkholderia_mallei",
        "Burkholderia_mayonis",
        "Burkholderia_oklahomensis",
        "Burkholderia_pseudomallei",
        "Burkholderia_savannae",
