...
include { SRST2_MLST                     } from '../../../modules/local/mlst/srst2local/main'
include { GET_MLST_SRST2                 } from '../../../modules/local/mlst/srst2/main'
include { CHECK_MLST                     } from '../../../modules/local/mlst/check/mlst/main'
include { CHECK_MLST_WITH_SRST2          } from '../../../modules/local/mlst/check/srst2/main'
