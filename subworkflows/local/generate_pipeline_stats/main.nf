...
include { GENERATE_PIPELINE_STATS      } from '../../../modules/local/phoenix/stats/generate/stats/main'
include { GENERATE_PIPELINE_STATS_EXQC } from '../../../modules/local/phoenix/stats/generate/exqc/main'
