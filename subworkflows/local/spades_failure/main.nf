...
include { CREATE_SUMMARY_LINE_FAILURE          } from '../../../modules/local/phoenix/summary/linefailure/main'
include { GENERATE_PIPELINE_STATS_FAILURE      } from '../../../modules/local/phoenix/stats/generate/failure/main'
include { GENERATE_PIPELINE_STATS_FAILURE_EXQC } from '../../../modules/local/phoenix/stats/generate/failureexqc/main'
include { DETERMINE_TAXA_ID_FAILURE            } from '../../../modules/local/phoenix/stats/taxaidfailure/main'
