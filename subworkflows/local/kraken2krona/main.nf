...
include { KRAKEN2_KRAKEN2 as KRAKEN2_TRIMD                  } from '../../../modules/local/kraken2/kraken2/main'
include { KRAKEN2_KRAKEN2 as KRAKEN2_ASMBLD                 } from '../../../modules/local/kraken2/kraken2/main'
include { KRAKEN2_KRAKEN2 as KRAKEN2_WTASMBLD               } from '../../../modules/local/kraken2/kraken2/main'
include { KRAKEN2_KRONA as KREPORT2KRONA_TRIMD              } from '../../../modules/local/krakentools/kreport2krona/main'
include { KRAKEN2_KRONA as KREPORT2KRONA_ASMBLD             } from '../../../modules/local/krakentools/kreport2krona/main'
include { KRAKEN2_KRONA as KREPORT2KRONA_WTASMBLD           } from '../../../modules/local/krakentools/kreport2krona/main'
include { KRONA_KTIMPORTTEXT as KRONA_KTIMPORTTEXT_TRIMD    } from '../../../modules/local/krona/ktimporttext/main'
include { KRONA_KTIMPORTTEXT as KRONA_KTIMPORTTEXT_ASMBLD   } from '../../../modules/local/krona/ktimporttext/main'
include { KRONA_KTIMPORTTEXT as KRONA_KTIMPORTTEXT_WTASMBLD } from '../../../modules/local/krona/ktimporttext/main'
include { KRAKENTOOLS_KREPORT2MPA as KREPORT2MPA_TRIMD      } from '../../../modules/local/krakentools/kreport2mpa/main'
include { KRAKENTOOLS_KREPORT2MPA as KREPORT2MPA_ASMBLD     } from '../../../modules/local/krakentools/kreport2mpa/main'
include { KRAKENTOOLS_MAKEKREPORT                           } from '../../../modules/local/krakentools/makereport/main.nf'
include { KRAKEN_BEST_HIT as KRAKEN2_BH_TRIMD               } from '../../../modules/local/kraken2/krakenbh/main'
include { KRAKEN_BEST_HIT as KRAKEN2_BH_ASMBLD              } from '../../../modules/local/kraken2/krakenbh/main'
include { KRAKEN_BEST_HIT as KRAKEN2_BH_WTASMBLD            } from '../../../modules/local/kraken2/krakenbh/main'
...
workflow KRAKEN2_WF {
    ...
    if(type =="trimd") {
        ...
        KRAKEN2_TRIMD (
            fasta_ch, kraken2_db_path, "trimd", true, true
        )
        ...
        KRAKEN2_ASMBLD (
            fasta_ch, kraken2_db_path, "asmbld", true, true
        )
        ...
        KRAKEN2_WTASMBLD (
            fasta_ch, kraken2_db_path, "wtasmbld", true, true
        )
        ...
        make_report_ch = KRAKEN2_WTASMBLD.out.classified_reads_assignment
