...
include { SCAFFOLDS_SAMPLESHEET_CHECK } from '../../../modules/local/samplesheets/scaffoldscheck/main'
include { CREATE_SAMPLESHEET          } from '../../../modules/local/samplesheets/create/main'
